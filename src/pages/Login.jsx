  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleSubmit} className="glass-card" style={{ padding: '40px', width: '100%', maxWidth: '400px', border: error ? '1px solid #ef4444' : '1px solid var(--glass-border)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: '30px', color: 'var(--primary)' }}>Acceso Administrativo</h2>
        
        {error && (
          <div style={{ padding: '12px', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', borderRadius: '8px', fontSize: '0.85rem', marginBottom: '20px', textAlign: 'center', border: '1px solid rgba(239, 68, 68, 0.2)' }}>
            {error}
          </div>
        )}
