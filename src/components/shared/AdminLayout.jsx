    ...
    <>
      ...
      <div style={{ marginBottom: '50px', padding: '0 10px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
          ...
          <Link to="/admin/notifications" onClick={() => setIsMenuOpen(false)} className={notifCount > 0 ? 'bell-animation' : ''} style={{ 
            position: 'relative', 
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div className="admin-mobile-header" style={{
        ...
        >
          {isMenuOpen ? <Globe size={24} style={{ transform: 'rotate(45deg)' }} /> : <LayoutDashboard size={24} />}
        </button>
      </div>
      ...
      {/* Sidebar */}
      <aside className={`admin-sidebar ${isMenuOpen ? 'open' : ''}`} style={{
        width: '280px',
        background: 'var(--primary)',
